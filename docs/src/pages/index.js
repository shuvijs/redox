    ...
    <div className={clsx('container', styles.hero)}>
      <div className={clsx('text--center', styles.heroInner)}>
        <h1 className={styles.heroTitleWrapper}>
          <span className={styles.heroTitle}>Redox</span>
          <span className={styles.gitHubButtonWrapper}>
            <iframe
              className={styles.gitHubButton}
              src="https://ghbtns.com/github-btn.html?user=shuvijs&amp;repo=redox&amp;type=star&amp;count=true&amp;size=large"
              width={160}
              height={30}
              title="GitHub Stars"
            />
    ...
    [
      {
        ...
        content:
          'Redox hooks into Redux devtools to give you an enhanced development experience.',
      },
      {
        title: '🔌 Extensible',
        content:
          'A flexiable plugin mechanism that makes it easy to extend Redox.',
      },
      {
